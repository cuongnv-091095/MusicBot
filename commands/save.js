...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        const embed = new EmbedBuilder()
            ...
            .setTimestamp()
            .setFooter({ text: `Customize by CươngNV from DIYEverything.xyz with ❤️` })
        interaction.user.send({ embeds: [embed] }).then(() => {
            ...
            interaction.reply({ content: `:x: Unable to send you private message.`, ephemeral: true }).catch(e => { })
        });
    },
};
